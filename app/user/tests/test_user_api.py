...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test password must be atlease 8 character"""
    ...
    def test_create_token_no_user(self):
        """Test no token is created if user doesnt exists"""
    ...
    def test_retrieve_user_unautherised(self):
        """Test authentication is required for users"""
        res= self.client.get(ME_URL)

        self.assertEqual(res.status_code, status.HTTP._401_UNAUTHORIZED)
